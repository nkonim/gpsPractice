...
//It retrieves the gps and places the 
function find(){
     if (navigator.geolocation) {
          navigator.geolocation.getCurrentPosition(function(position) {
            ...
            alert('Please turn on the device\'s GPS');
          });
        } else {
            alert('GPS failed');
        }
...
//This function detects the device and adjusts the map
